  ...
  componentWillMount() {
    ...
    this._panSpeeDot = PanResponder.create({
      ...
      onPanResponderGrant: (evt, gestureState) => {
        ...
        this.refs.gotimeSpeed.setNativeProps({
          style: {opacity: 1, display: null, width: null}
        });
    ...
    try {
      ...
      if (this.state.showConts) {
        ...
        this.AnimatedOp.start(() => {
          this.setState({showConts: true, showChangeList: false});
          this.hide.stop();
        ...
        <View
                ...
                <View style={{flexDirection: 'row', flexWrap: 'nowrap'}}>
                  ...
                  {!this.props.continuous ? (
                    this.state.paused ? (
                      <TouchableOpacity
                        activeOpacity={1}
                        style={{bottom: 0, left: 5, padding: 10, zIndex: 999}}
                        onPress={() => {
                          if (!showOpenVip) {
                            this.rePlay();
                          }
          ...
          <View
            ...
            <View
              ...
              <View>
                <Text style={{color: '#fff'}}>{goSpeedTime}</Text>
              </View>
              <View>
                <Text style={{color: '#fff'}}>/</Text>
              </View>
              <View>
                <Text style={{color: '#fff'}}>{allTime}</Text>
              </View>
            </View>
          </View>
          ...
          {this.state.showVolume ? <Volume {...this.state} /> : null}

          {
            /* 亮度*/
            this.state.showBrightness ? <Brightness {...this.state} /> : null
          }
